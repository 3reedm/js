...
jQuery.fn.yaproFieldHelp = function(field_name, t, td, padding_left, padding_top){
	...
	var help = $('<table border="0" cellpadding="0" cellspacing="0" id="yaproField'+field_name+'" class="yaproField" style="left: '+(position.Right + padding_left)+'px; top: '+(position.Top + padding_top)+'px;"><tr><td class="yaproFieldPointer"> </td>').data("yaproField", o[0]).click(function(){ $(o[0]).focus(); $(this).remove(); });
	$.jGrowl(t);
